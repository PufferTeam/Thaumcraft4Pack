...
mods.botania.Lexicon.addAlchemyPage("botania.page.manaAlchemy26", "botania.entry.manaAlchemy", 26, [alumentum], [coal], [2000]);
game.setLocalization("en_US", "botania.page.manaAlchemy26", "Creating &1Alumentum&0");
